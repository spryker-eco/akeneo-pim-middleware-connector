<?php  //[STAMP] 0d0ba91a87fd784a0125e9e21c5650be
namespace SprykerEcoTest\Zed\AkeneoPimMiddlewareConnector\_generated;

// This class was automatically generated by build task
// You should not change it manually as it will be overwritten on next build
// @codingStandardsIgnoreFile

trait AkeneoPimMiddlewareConnectorZedTesterActions
{
    /**
     ...
     *
     * @return string[]
     * @see \SprykerEcoTest\Zed\AkeneoPimMiddlewareConnector\Helper\SuperAttributeAkeneoApiStreamPluginHelper::getExpectedVariantCodes()
     */
    public function getExpectedVariantCodes() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getExpectedVariantCodes', func_get_args()));
    }
     ...
     *
     * @return array
     * @see \SprykerEcoTest\Zed\AkeneoPimMiddlewareConnector\Helper\SuperAttributeAkeneoApiStreamPluginHelper::processSuperAttributesAkeneoReadPlugin()
     */
    public function processSuperAttributesAkeneoReadPlugin() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('processSuperAttributesAkeneoReadPlugin', func_get_args()));
    }
}
