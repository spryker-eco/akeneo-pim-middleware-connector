 ...
 */
class ProductModelPreparationTranslationStagePlugin extends AbstractPlugin implements TranslatorStagePluginInterface
{
    /**
    ...
    public function getTranslatorConfig(): TranslatorConfigTransfer
    {
        return $this->getFacade()
            ->getProductModelPreparationTranslatorConfig();
    }
