 ...
 */
class DefaultCategoryImportTranslationStagePlugin extends AbstractPlugin implements TranslatorStagePluginInterface
{
    /**
    ...
    public function getTranslatorConfig(): TranslatorConfigTransfer
    {
        return $this->getFacade()
            ->getDefaultCategoryImportTranslatorConfig();
    }
