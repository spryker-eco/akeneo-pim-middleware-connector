 ...
 */
class TaxSetMapImportConfigurationPlugin implements ProcessConfigurationPluginInterface
{
    const PROCESS_NAME = 'TAX_SET_MAP_IMPORT_PROCESS';
    ...
    public function getInputStreamPlugin(): InputStreamPluginInterface
    {
        return $this->getFactory()
            ->getTaxSetMapImportInputStreamPlugin();
    }
    ...
    {
        return $this->getFactory()
            ->getTaxSetMapImportOutputStreamPlugin();
    }
    ...
    {
        return $this->getFactory()
            ->getTaxSetMapImportIteratorPlugin();
    }
    ...
    {
        return $this->getFactory()
            ->getTaxSetMapImportStagePluginsStack();
    }
    ...
    {
        return $this->getFactory()
            ->getTaxSetMapImportPreProcessorPluginsStack();
    }
    ...
    {
        return $this->getFactory()
            ->getTaxSetMapImportPostProcessorPluginsStack();
    }
}
