...
class SuperAttributeImportConfigurationPlugin extends AbstractPlugin implements ProcessConfigurationPluginInterface
{
    ...
    public function getInputStreamPlugin(): InputStreamPluginInterface
    {
        return $this->getFactory()
            ->getSuperAttributesImportInputStreamPlugin();
    }
    ...
    {
        return $this->getFactory()
            ->getSuperAttributesImportOutputStreamPlugin();
    }
    ...
    {
        return $this->getFactory()
            ->getSuperAttributesImportIteratorPlugin();
    }
    ...
    {
        return $this->getFactory()
            ->getSuperAttributesImportStagePluginsStack();
    }
    ...
    {
        return $this->getFactory()
            ->getSuperAttributesImportPreProcessorPluginsStack();
    }
    ...
    {
        return $this->getFactory()
            ->getSuperAttributesImportPostProcessorPluginsStack();
    }
}
