...
{
    const PROCESS_NAME = 'PRODUCT_MODEL_PREPARATION_PROCESS';
    ...
    public function getInputStreamPlugin(): InputStreamPluginInterface
    {
        return $this->getFactory()
            ->getProductModelPreparationInputStreamPlugin();
    }
    ...
    {
        return $this->getFactory()
            ->getProductModelPreparationOutputStreamPlugin();
    }
    ...
    {
        return $this->getFactory()
            ->getProductModelPreparationIteratorPlugin();
    }
    ...
    {
        return $this->getFactory()
            ->getProductModelPreparationStagePluginsStack();
    }
    ...
    {
        return $this->getFactory()
            ->getProductModelPreparationPreProcessorPluginsStack();
    }
    ...
    {
        return $this->getFactory()
            ->getProductModelPreparationPostProcessorPluginsStack();
    }
}
