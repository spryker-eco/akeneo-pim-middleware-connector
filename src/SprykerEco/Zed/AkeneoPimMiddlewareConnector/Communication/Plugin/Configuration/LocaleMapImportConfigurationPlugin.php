 ...
 */
class LocaleMapImportConfigurationPlugin implements ProcessConfigurationPluginInterface
{
    ...
    {
        return $this->getFactory()
            ->getLocaleMapOutputStreamPlugin();
    }
    ...
    {
        return $this->getFactory()
            ->getLocaleMapPreProcessorPluginsStack();
    }
    ...
    {
        return $this->getFactory()
            ->getLocaleMapPostProcessorPluginsStack();
    }
}
