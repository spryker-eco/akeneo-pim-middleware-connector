 ...
 */
class ProductModelImportConfigurationPlugin implements ProcessConfigurationPluginInterface
{
    const PROCESS_NAME = 'PRODUCT_MODEL_IMPORT_PROCESS';
    ...
    {
        return $this->getFactory()
            ->getProductModelImportStagePluginsStack();
    }
